...
set_property PACKAGE_PIN W3 [get_ports {FSM_LED_V[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {FSM_LED_V[0]}]
set_property PACKAGE_PIN U3 [get_ports {FSM_LED_V[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {FSM_LED_V[1]}]
set_property PACKAGE_PIN P3 [get_ports {FSM_LED_V[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {FSM_LED_V[2]}]
set_property PACKAGE_PIN N3 [get_ports {FSM_LED_H[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {FSM_LED_H[0]}]
set_property PACKAGE_PIN P1 [get_ports {FSM_LED_H[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {FSM_LED_H[1]}]
set_property PACKAGE_PIN L1 [get_ports {FSM_LED_H[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {FSM_LED_H[2]}]
...
##Sch name = JA3
set_property PACKAGE_PIN J2 [get_ports {PWM_FSM_H}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {PWM_FSM_H}]
##Sch name = JA4
set_property PACKAGE_PIN G2 [get_ports {PWM_FSM_V}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {PWM_FSM_V}]
##Sch name = JA7
